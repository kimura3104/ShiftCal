class AuthController < ApplicationController
  def google_oauth2_callback
    ...
    authorization = Google::Auth::UserAuthorizer.new(client_id, Google::Apis::CalendarV3::AUTH_CALENDAR, token_store, "http://localhost:3000/auth/google_oauth2/callback")
